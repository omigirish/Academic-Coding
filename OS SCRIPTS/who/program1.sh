...
#1.Find and display the path of the file
#2.Calculate and display no of vowels in the file
#3.Calc and display number of punctuations in the file
...
echo -e "\nUpdated file:\n "
echo -e "`sed '3s/$/ AGE= '$yyy'/' $1`"
echo -e "`sed '3s/$/ AGE= '$yyy'/' $1|cat >> $1`"
echo
echo -e "`sed '4s/$/ CGPI= '$cgpi'/' $1`"
echo -e "`sed '4s/$/ CGPI= '$cgpi'/' $1|cat >>$1`"
echo
